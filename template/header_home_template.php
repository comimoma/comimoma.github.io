            ...
            <div class="collapse navbar-collapse px-4" id="navmenu">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item text-uppercase">
                        <a href="/index.php" class="nav-link tagRemove">Home</a>
                    </li>
                    <li class="nav-item text-uppercase">
                        <a href="#services" class="nav-link tagRemove">Services</a>
                    </li>
                    <li class="nav-item  text-uppercase">
                        <a href="#blog" class="nav-link tagRemove">Blog</a>
                    </li>
                    <li class="nav-item  text-uppercase">
                        <a href="#about" class="nav-link tagRemove">About</a>
                    </li>
                    <li class="nav-item  text-uppercase">
                        <a href="#team" class="nav-link tagRemove">Team</a>
                    </li>
                    <li class="nav-item  text-uppercase">
                        <a href="#contact" class="nav-link tagRemove">Contact</a>
                    </li>
                </ul>
